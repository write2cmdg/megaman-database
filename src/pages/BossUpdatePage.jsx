        ...
        >
          ...
          <div className="mb-2 flex flex-row justify-between">
            ...
            <input
              ...
              id="hp"
              placeholder={data.hp}
              onChange={(e) => setValues({ ...values, hp: e.target.value })}
            />
          </div>
          ...
          <div className="mb-2 flex flex-row justify-between">
            ...
            <input
              ...
              name="weapon"
              id="weapon"
              placeholder={data.weapon}
              onChange={(e) => setValues({ ...values, weapon: e.target.value })}
            />
          </div>
          ...
          <div className="mb-2 flex flex-row justify-between">
            ...
            <input
              ...
              name="weakness"
              id="weakness"
              placeholder={data.weakness}
              onChange={(e) =>
                setValues({ ...values, weakness: e.target.value })
              }
            />
          </div>
          ...
          <div className="mb-2 flex flex-row justify-between">
            ...
            <input
              ...
              name="game"
              id="game"
              placeholder={data.game}
              onChange={(e) => setValues({ ...values, game: e.target.value })}
            />
          </div>

          <button className="mt-8 font-press-start text-lg hover:text-yellow-200 hover:bg-red-800 hover:border-red-900 text-blue-200 bg-blue-900 my-2 border-blue-900 border-4 p-1 rounded-lg uppercase">
            update
          </button>
        </Form>
